...
public class Vue extends JFrame {
    ...
    private void creerWidget() {
        ...
        for (int i =0 ; i<2;i++){
            CarteVaisseauColon carte = new CarteVaisseauColon("D:/Ganymede_tirerCarte/src/img/navette/6PV.png",Effet.six_pv_si_utiliser_au_moins_une_navette_de_chaque);
            CarteVaisseauColon carte1 = new CarteVaisseauColon("D:/Ganymede_tirerCarte/src/img/navette/5pv.png",Effet.cinqPV);
            CarteVaisseauColon carte2 = new CarteVaisseauColon("D:/Ganymede_tirerCarte/src/img/navette/PV_egale_reput.png",Effet.pv_egale_reput);
            CarteVaisseauColon carte3 = new CarteVaisseauColon("D:/Ganymede_tirerCarte/src/img/navette/4PV_reput_plus_1.png",Effet.quatre_pv_plus_un_reput);
            CarteVaisseauColon carte4 = new CarteVaisseauColon("D:/Ganymede_tirerCarte/src/img/navette/4PV_1colon_terre.png",Effet.quatre_pv_recruter_colon_terre);
            CarteVaisseauColon carte5 = new CarteVaisseauColon("D:/Ganymede_tirerCarte/src/img/navette/4PV_moins1.png",Effet.quatre_pv_moins_un_colon_por_decole);
            CarteVaisseauColon carte6 = new CarteVaisseauColon("D:/Ganymede_tirerCarte/src/img/navette/4PV_2transfers.png",Effet.quatre_pv_plus_deux_transfers);
            CarteVaisseauColon carte7 = new CarteVaisseauColon("D:/Ganymede_tirerCarte/src/img/navette/2PV_type_navette_rouge.png",Effet.deuxPV_rouge_navette_fin_tour);
            CarteVaisseauColon carte8 = new CarteVaisseauColon("D:/Ganymede_tirerCarte/src/img/navette/2PV_type_navette_violet.png",Effet.deuxPV_violet_navette_fin_tour);
            CarteVaisseauColon carte9 = new CarteVaisseauColon("D:/Ganymede_tirerCarte/src/img/navette/2PV_type_navette_jaune.png",Effet.deuxPV_jaune_navette_fin_tour);
            CarteVaisseauColon carte10 = new CarteVaisseauColon("D:/Ganymede_tirerCarte/src/img/navette/2PV_type_navette_bleu.png",Effet.deuxPV_bleu_navette_fin_tour);
            CarteVaisseauColon carte11 = new CarteVaisseauColon("D:/Ganymede_tirerCarte/src/img/navette/2PV_type_navette.png",Effet.deuxPV_blanc_navette_fin_tour);
            CarteVaisseauColon carte12 = new CarteVaisseauColon("D:/Ganymede_tirerCarte/src/img/navette/1PV_par_symbole_colon_rouge.png",Effet.un_pv_rouge_navtte);
            CarteVaisseauColon carte13 = new CarteVaisseauColon("D:/Ganymede_tirerCarte/src/img/navette/1PV_par_symbole_colon_jaune.png",Effet.un_pv_jaune_navtte);
            CarteVaisseauColon carte14 = new CarteVaisseauColon("D:/Ganymede_tirerCarte/src/img/navette/1PV_par_symbole_colon_bleu.png",Effet.un_pv_bleu_navtte);
            CarteVaisseauColon carte15 = new CarteVaisseauColon("D:/Ganymede_tirerCarte/src/img/navette/1PV_par_symbole_colon_violet.png",Effet.un_pv_violet_navtte);
            CarteVaisseauColon carte16 = new CarteVaisseauColon("D:/Ganymede_tirerCarte/src/img/navette/2PV_par_tuile.png",Effet.deux_pv_par_tuile_posseder_fin_partie);
        ...
        for (int j = 0; j < 2 ; j++){
            TuileColon tuile1 = new TuileColon(EffetTuile.transfert_ou_recrute_jaune_type_blanc,Couleur.BLANC,"D:/Ganymede_tirerCarte/src/img/Tuile/transfert_ou_recrute_jaune_type_blanc.png");
            TuileColon tuile2 = new TuileColon(EffetTuile.recrute_bleu_ou_violet_type_violet,Couleur.BLANC,"D:/Ganymede_tirerCarte/src/img/Tuile/recrute_bleu_ou_violet_type_violet.png");
            TuileColon tuile3 = new TuileColon(EffetTuile.transfert_ou_recrute_violet_type_blanc,Couleur.BLANC,"D:/Ganymede_tirerCarte/src/img/Tuile/transfert_ou_recrute_violet_type_blanc.png");
            TuileColon tuile4 = new TuileColon(EffetTuile.transfert_ou_recrute_bleu_type_blanc,Couleur.BLANC,"D:/Ganymede_tirerCarte/src/img/Tuile/transfert_ou_recrute_bleu_type_bleu.png");
            TuileColon tuile5 = new TuileColon(EffetTuile.transfert_ou_reput_type_blanc,Couleur.BLANC,"D:/Ganymede_tirerCarte/src/img/Tuile/transfert_ou_reput_type_blanc.png");
            TuileColon tuile6 = new TuileColon(EffetTuile.transdert_plus_decolage_fuse,Couleur.BLANC,"D:/Ganymede_tirerCarte/src/img/Tuile/transdert_plus_decolage_fuse.png");

            TuileColon tuile7 = new TuileColon(EffetTuile.recrute_bleu_ou_violet_type_violet,Couleur.VIOLET,"D:/Ganymede_tirerCarte/src/img/Tuile/recrute_bleu_ou_violet_type_violet.png");
            TuileColon tuile8 = new TuileColon(EffetTuile.transfert_ou_recrute_violet_type_violet,Couleur.VIOLET,"D:/Ganymede_tirerCarte/src/img/Tuile/transfert_ou_recrute_violet_type_violet.png");
            TuileColon tuile9 = new TuileColon(EffetTuile.recrute_violet_ou_bleu_type_violet,Couleur.VIOLET,"D:/Ganymede_tirerCarte/src/img/Tuile/recrute_violet_ou_bleu_type_violet.png");
            TuileColon tuile10 = new TuileColon(EffetTuile.recrute_violet_ou_jaune_type_violet,Couleur.VIOLET,"D:/Ganymede_tirerCarte/src/img/Tuile/recrute_violet_ou_jaune_type_violet.png");
            TuileColon tuile11 = new TuileColon(EffetTuile.recrute_violet_ou_reputation_type_violet,Couleur.VIOLET,"D:/Ganymede_tirerCarte/src/img/Tuile/recrute_violet_ou_reputation_type_violet.png");
            TuileColon tuile12 = new TuileColon(EffetTuile.recrute_violet_plus_decolage_type_violet,Couleur.VIOLET,"D:/Ganymede_tirerCarte/src/img/Tuile/recrute_violet_plus_decolage_type_violet.png");

            TuileColon tuile13 = new TuileColon(EffetTuile.recrute_bleu_ou_rouge_type_rouge,Couleur.ROUGE,"D:/Ganymede_tirerCarte/src/img/Tuile/recrute_bleu_ou_rouge_type_rouge.png");
            TuileColon tuile14 = new TuileColon(EffetTuile.recrute_rouge_ou_jaune_type_rouge,Couleur.ROUGE,"D:/Ganymede_tirerCarte/src/img/Tuile/recrute_rouge_ou_jaune_type_rouge.png");
            TuileColon tuile15 = new TuileColon(EffetTuile.recrute_rouge_ou_reptation_type_rouge,Couleur.ROUGE,"D:/Ganymede_tirerCarte/src/img/Tuile/recrute_rouge_ou_reptation_type_rouge.png");
            TuileColon tuile16 = new TuileColon(EffetTuile.recrute_rouge_ou_transfert_type_rouge,Couleur.ROUGE,"D:/Ganymede_tirerCarte/src/img/Tuile/recrute_rouge_ou_transfert_type_rouge.png");
            TuileColon tuile17 = new TuileColon(EffetTuile.recrute_rouge_ou_violet_type_rouge,Couleur.ROUGE,"D:/Ganymede_tirerCarte/src/img/Tuile/recrute_rouge_ou_violet_type_rouge.png");
            TuileColon tuile18 = new TuileColon(EffetTuile.recrute_rouge_plus_decole_type_rouge,Couleur.ROUGE,"D:/Ganymede_tirerCarte/src/img/Tuile/recrute_rouge_plus_decole_type_rouge.png");

            TuileColon tuile19 = new TuileColon(EffetTuile.recrute_bleu_ou_jaune_type_bleu,Couleur.BLEU,"D:/Ganymede_tirerCarte/src/img/Tuile/recrute_bleu_ou_jaune_type_bleu.png");
            TuileColon tuile20 = new TuileColon(EffetTuile.recrute_bleu_ou_repute_type_bleu,Couleur.BLEU,"D:/Ganymede_tirerCarte/src/img/Tuile/recrute_bleu_ou_repute_type_bleu.png");
            TuileColon tuile21 = new TuileColon(EffetTuile.recrute_bleu_ou_rouge_type_bleu,Couleur.BLEU,"D:/Ganymede_tirerCarte/src/img/Tuile/recrute_bleu_ou_rouge_type_bleu.png");
            TuileColon tuile22 = new TuileColon(EffetTuile.recrute_bleu_ou_violet_type_bleu,Couleur.BLEU,"D:/Ganymede_tirerCarte/src/img/Tuile/recrute_bleu_ou_violet_type_bleu.png");
            TuileColon tuile23 = new TuileColon(EffetTuile.recrute_bleu_plus_decole_type_bleu,Couleur.BLEU,"D:/Ganymede_tirerCarte/src/img/Tuile/recrute_bleu_plus_decole_type_bleu.png");
            TuileColon tuile24 = new TuileColon(EffetTuile.transfert_ou_recrute_bleu_type_bleu,Couleur.BLEU,"D:/Ganymede_tirerCarte/src/img/Tuile/transfert_ou_recrute_bleu_type_bleu.png");

            TuileColon tuile25 = new TuileColon(EffetTuile.recrute_jaune_ou_bleu_type_jaune,Couleur.JAUNE,"D:/Ganymede_tirerCarte/src/img/Tuile/recrute_jaune_ou_bleu_type_jaune.png");
            TuileColon tuile26 = new TuileColon(EffetTuile.recrute_jaune_ou_reput_type_jaune,Couleur.JAUNE,"D:/Ganymede_tirerCarte/src/img/Tuile/recrute_jaune_ou_reput_type_jaune.png");
            TuileColon tuile27 = new TuileColon(EffetTuile.recrute_jaune_ou_tansfert_type_jaune,Couleur.JAUNE,"D:/Ganymede_tirerCarte/src/img/Tuile/recrute_jaune_ou_tansfert_type_jaune.png");
            TuileColon tuile28 = new TuileColon(EffetTuile.recrute_jaune_ou_violet_type_jaune,Couleur.JAUNE,"D:/Ganymede_tirerCarte/src/img/Tuile/recrute_jaune_ou_violet_type_jaune.png");
            TuileColon tuile29 = new TuileColon(EffetTuile.recrute_jaune_plus_decole_type_jaune,Couleur.JAUNE,"D:/Ganymede_tirerCarte/src/img/Tuile/recrute_jaune_plus_decole_type_jaune.png");
            TuileColon tuile30 = new TuileColon(EffetTuile.recrute_jaune_ou_rouge_type_jaune,Couleur.JAUNE,"D:/Ganymede_tirerCarte/src/img/Tuile/recrute_jaune_ou_rouge_type_jaune.png");
        ...
        CarteMars mars1 = new CarteMars("D:/Ganymede_tirerCarte/src/img/mars/deplace_colon_bleu_defausse_tuile_recrute_colon_type_blanc.jpg",ActionMars.recrute_colon, DeplacementColonMars.deplace_colon_bleu_defausse_tuile,Couleur.BLANC);
        CarteMars mars2 = new CarteMars("D:/Ganymede_tirerCarte/src/img/mars/deplace_colon_bleu_violet_reput_type_blanc.jpg",ActionMars.reput, DeplacementColonMars.deplace_colon_bleu_violet,Couleur.BLANC);
        CarteMars mars3 = new CarteMars("D:/Ganymede_tirerCarte/src/img/mars/deplace_colon_jaune_transfert_type_blanc.jpg",ActionMars.transfert, DeplacementColonMars.deplace_colon_jaune,Couleur.BLANC);
        CarteMars mars4 = new CarteMars("D:/Ganymede_tirerCarte/src/img/mars/deplace_colon_rouge_echanger_colon_rouge_type_blanc.jpg",ActionMars.echanger_colon_rouge, DeplacementColonMars.deplace_colon_rouge,Couleur.BLANC);
        CarteMars mars5 = new CarteMars("D:/Ganymede_tirerCarte/src/img/mars/deplace_deux_colon_defausse_tuile_action_basique_type_blanc.jpg",ActionMars.action_basique, DeplacementColonMars.deplace_deux_colon_defausse_tuile,Couleur.BLANC);
        CarteMars mars6 = new CarteMars("D:/Ganymede_tirerCarte/src/img/mars/deplace_deux_colon_violet_action_basique_type_blanc.jpg",ActionMars.action_basique, DeplacementColonMars.deplace_deux_colon_violet,Couleur.BLANC);

        CarteMars mars7 = new CarteMars("D:/Ganymede_tirerCarte/src/img/mars/deplace_bleu_rouge_jaune_plus_recrute_violet_ou_bleu_type_bleu.jpg",ActionMars.recrute_violet_ou_bleu, DeplacementColonMars.deplace_bleu_rouge_jaune,Couleur.BLEU);
        CarteMars mars8 = new CarteMars("D:/Ganymede_tirerCarte/src/img/mars/deplace_bleu_rouge_violet_plus_reput_type_bleu.jpg",ActionMars.reput, DeplacementColonMars.deplace_bleu_rouge_violet,Couleur.BLEU);
        CarteMars mars9 = new CarteMars("D:/Ganymede_tirerCarte/src/img/mars/deplace_rouge_bleu_echanger_colon_contre_jaune_type_bleu.jpg",ActionMars.echanger_colon_contre_jaune, DeplacementColonMars.deplace_rouge_bleu,Couleur.BLEU);
        CarteMars mars10 = new CarteMars("D:/Ganymede_tirerCarte/src/img/mars/deplacer_bleu_et_jaune_plus_transfert_type_bleu.jpg",ActionMars.transfert, DeplacementColonMars.deplacer_bleu_et_jaune,Couleur.BLEU);
        CarteMars mars11 = new CarteMars("D:/Ganymede_tirerCarte/src/img/mars/deplacer_deux_bleu_defausser_tuile_recrute_rouge_ou_jaune_type_bleu.jpg",ActionMars.recrute_rouge_ou_jaune, DeplacementColonMars.deplacer_deux_bleu_defausser_tuile,Couleur.BLEU);
        CarteMars mars12 = new CarteMars("D:/Ganymede_tirerCarte/src/img/mars/deplacer_dex_colon_bleu_plus_defausser_tuile_plus_action_basiqe_type_bleu.png",ActionMars.action_basique, DeplacementColonMars.deplacer_dex_colon_bleu_plus_defausser_tuile,Couleur.BLEU);

        CarteMars mars13 = new CarteMars("D:/Ganymede_tirerCarte/src/img/mars/deplace_deux_jaune_bleu_recrute_colon_type_jaune.jpg",ActionMars.recrute_colon, DeplacementColonMars.deplace_deux_jaune_bleu,Couleur.JAUNE);
        CarteMars mars14 = new CarteMars("D:/Ganymede_tirerCarte/src/img/mars/deplace_deux_jaune_defausse_tuile_action_basique_type_jaune.jpg",ActionMars.action_basique, DeplacementColonMars.deplace_deux_jaune,Couleur.JAUNE);
        CarteMars mars15 = new CarteMars("D:/Ganymede_tirerCarte/src/img/mars/deplace_deux_jaune_transfert_type_jaune.jpg",ActionMars.transfert, DeplacementColonMars.deplace_deux_jaune,Couleur.JAUNE);
        CarteMars mars16 = new CarteMars("D:/Ganymede_tirerCarte/src/img/mars/deplace_jaune_rouge_echanger_colon_contre_violet_type_jaune.jpg",ActionMars.echanger_colon_contre_violet, DeplacementColonMars.deplace_jaune_rouge,Couleur.JAUNE);
        CarteMars mars17 = new CarteMars("D:/Ganymede_tirerCarte/src/img/mars/deplace_jaune_violet_bleu_reput_type_jaune.jpg",ActionMars.reput, DeplacementColonMars.deplace_jaune_violet_bleu,Couleur.JAUNE);
        CarteMars mars18 = new CarteMars("D:/Ganymede_tirerCarte/src/img/mars/deplace_jaune_violet_bleu_transfert_type_jaune.jpg",ActionMars.transfert, DeplacementColonMars.deplace_jaune_violet_bleu,Couleur.JAUNE);

        CarteMars mars19 = new CarteMars("D:/Ganymede_tirerCarte/src/img/mars/deplace_deux_violet_defausse_tuile_action_basique_type_violet.jpg",ActionMars.action_basique, DeplacementColonMars.deplace_deux_violet_defausse_tuile,Couleur.VIOLET);
        CarteMars mars20 = new CarteMars("D:/Ganymede_tirerCarte/src/img/mars/deplace_deux_violet_defausse_tuile_reput_type_violet.jpg",ActionMars.reput, DeplacementColonMars.deplace_deux_violet_defausse_tuile,Couleur.VIOLET);
        CarteMars mars21 = new CarteMars("D:/Ganymede_tirerCarte/src/img/mars/deplace_deux_violet_recrute_colon_type_violet.jpg",ActionMars.recrute_colon_type_violet, DeplacementColonMars.deplace_deux_violet,Couleur.VIOLET);
        CarteMars mars22 = new CarteMars("D:/Ganymede_tirerCarte/src/img/mars/deplace_violet_bleu_rouge_plus_reput_type_violet.jpg",ActionMars.reput, DeplacementColonMars.deplace_violet_bleu_rouge,Couleur.VIOLET);
        CarteMars mars23 = new CarteMars("D:/Ganymede_tirerCarte/src/img/mars/deplace_violet_jaune_transfert_type_violet.jpg",ActionMars.transfert, DeplacementColonMars.deplace_violet_jaune,Couleur.VIOLET);
        CarteMars mars24 = new CarteMars("D:/Ganymede_tirerCarte/src/img/mars/deplace_violet_rouge_echanger_avec_colon_bleu_type_violet.jpg",ActionMars.echanger_avec_colon_bleu_type_violet, DeplacementColonMars.deplace_violet_rouge,Couleur.VIOLET);

        CarteMars mars25 = new CarteMars("D:/Ganymede_tirerCarte/src/img/mars/deplace_deux_rouge_bleu_recruter_colon_type_rouge.jpg",ActionMars.recruter_colon, DeplacementColonMars.deplace_deux_rouge_bleu,Couleur.ROUGE);
        CarteMars mars26 = new CarteMars("D:/Ganymede_tirerCarte/src/img/mars/deplace_deux_rouge_defausse_tuile_action_basique_type_rouge.jpg",ActionMars.action_basique, DeplacementColonMars.deplace_deux_rouge_defausse_tuile,Couleur.ROUGE);
        CarteMars mars27 = new CarteMars("D:/Ganymede_tirerCarte/src/img/mars/deplace_deux_rouge_echnager_colon_type_rouge.jpg",ActionMars.echanger_colon, DeplacementColonMars.deplace_deux_rouge,Couleur.ROUGE);
        CarteMars mars28 = new CarteMars("D:/Ganymede_tirerCarte/src/img/mars/deplace_rouge_jaune_violet_plus_echanger_colon_type_rouge.jpg",ActionMars.echanger_colon, DeplacementColonMars.deplace_rouge_jaune_violet,Couleur.ROUGE);
        CarteMars mars29 = new CarteMars("D:/Ganymede_tirerCarte/src/img/mars/deplace_rouge_jaune_violet_plus_reput_type_rouge.jpg",ActionMars.reput, DeplacementColonMars.deplace_rouge_jaune_violet,Couleur.ROUGE);
        CarteMars mars30 = new CarteMars("D:/Ganymede_tirerCarte/src/img/mars/deplacer_rouge_jaune_transferts_type_rouge.jpg.jpg",ActionMars.transfert, DeplacementColonMars.deplacer_rouge_jaune,Couleur.ROUGE);
